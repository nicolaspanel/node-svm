...
var performKFoldCrossValidation = function(svm, dataset, kfold, callback){
  svm.performKFoldCrossValidation(dataset, kfold, callback);
};
...
exports.performKFoldCrossValidation = performKFoldCrossValidation;
