...
function train(logger, options) {
    ...
    var interactive = options.interactive !== false && defaults.interactive;
        ...
        .then(function (good) {
            ...
            return read(datasetPath)
                ...
                .spread(function (model, report) {
                    ...
                    logger.info('train', 'done training');
                    ...
                    var bestConf = _o.merge(config, model.params);
                    // reformat conf a bit
