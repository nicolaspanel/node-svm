...
var SVM = function(args){
  ...
  this.modelFileName = args.modelFileName ? args.modelFileName : 'svm_model.model';
};
...
SVM.prototype.train = function(problem, callback) {
  ...
  addon.svmTrain(problem, params, function (modelLocation, error) {
    self.emit('trained', modelLocation, error);
  });
};
