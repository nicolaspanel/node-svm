...
var createError = require('../helpers/create-error');
...
BaseSVM.prototype.predictProbabilitiesSync = function(inputs) {
    ...
    return _a.zip(this._labels, probs).reduce(function(res, tuple){
        res[tuple[0]] = tuple[1];
        return res;
    }, {});
};
BaseSVM.prototype.predictProbabilities = function(inputs) {
    ...
    this._clf.predictProbabilitiesAsync(inputs, function (probs) {
        var result = _a.zip(self._labels, probs).reduce(function(res, tuple){
            res[tuple[0]] = tuple[1];
            return res;
        }, {});
